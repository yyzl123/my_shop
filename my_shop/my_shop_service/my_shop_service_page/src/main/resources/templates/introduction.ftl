...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd" id="loginDiv">
						<a href="http://localhost:9093/showLogin" target="_top" class="h">亲，请登录</a>
			...
			<ul class="message-r">
				<div class="topMessage home">
					<div class="menu-hd"><a href="http://localhost:9092/index" target="_top" class="h">商城首页</a></div>
				</div>
				<div class="topMessage my-shangcheng">
					<div class="menu-hd MyShangcheng"><a href="#" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
				</div>
				<div class="topMessage mini-cart">
					<div class="menu-hd"><a id="mc-menu-hd" href="http://localhost:9097/cart/show" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
				</div>
			...
			<div class="nav white">
				...
				<div class="search-bar pr">
					...
					<form action="http://localhost:8095/search">
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${pro.pimage}"><img src="${pro.pimage}" alt="细节展示放大镜特效" rel="${pro.pimage}" class="jqzoom" /></a>
							</div>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">${pro.price}</b>  </dd>
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">${pro.price}</b></dd>
								</li>
								<div class="clear"></div>
							</div>
							...
							<dl class="iteminfo_parameter sys_item_specpara">
                            	...
                            	<span class="gods-counter">
                                    ...
                                    <span class="gods-counter-btn">
                                        ...
                                        <span class="gods-counter-reduce page_icon" title="减" onclick="aut()"></span>
                                    </span>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login" >
									<a id="LikBasket" title="加入购物车" href="#" onclick="addCart(${pro.pid})"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
		...
		<script >
			$.ajax({
				url: 'http://localhost:9093/checkIsLogin',
				//允许携带证书
				xhrFields: {
				...
				success:function(d){
					...
					if(d.errno==0){
						//欢迎你...
						var user  = d.data;
						$("#loginDiv").html("<a href='#' target='_top' class='h'>欢迎你，"+user.uname+"</a><a href='javaScript:void(0)' onclick='myLogout()' target='_top'>退出</a>");
					}
				}
			})
			...
			function addCart(pid) {
				...
				console.log(count);
				$.ajax({
					url:'http://localhost:9097/cart/add/'+pid +'/'+ count,
					//允许携带证书
					xhrFields: {
						withCredentials: true
					},
					...
					success:function (res) {
						alert(res.message);
						location.href='http://localhost:8096/'+pid +'.html';
					}
				})
			}
			...
			function myLogout() {
				$.ajax({
					url: 'http://localhost:9093/myLogout',
					//允许携带证书
					xhrFields: {
						withCredentials: true
					},
					...
					success:function(d){
						console.log(d);
						if(d.errno==0){
							$("#loginDiv").html("<a href=\"#\" target=\"_top\" class=\"h\">亲，请登录</a>\n" +
									"\t\t\t\t\t\t\t<a href=\"#\" target=\"_top\">免费注册</a>");
						}
					}
				})
